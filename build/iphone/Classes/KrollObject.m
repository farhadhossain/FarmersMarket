...
//@interface FarmersMarketObject : NSObject
//@end

@interface FarmersMarketObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FarmersMarketObject class]])
		{
			for (NSString *key in [[(FarmersMarketObject*)o modules] allKeys])
			{
