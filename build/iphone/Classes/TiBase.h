...
// in simulator we redefine to format for FarmersMarket Developer console
...
{\
	NSString * exceptionName = [@"org.farmersmarket." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.farmersmarket";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIFarmersMarketNativeItemNone = -1, 
	UIFarmersMarketNativeItemSpinner = -2,
	UIFarmersMarketNativeItemProgressBar = -3,
	
	UIFarmersMarketNativeItemSlider = -4,
	UIFarmersMarketNativeItemSwitch = -5,
	UIFarmersMarketNativeItemMultiButton = -6,
	UIFarmersMarketNativeItemSegmented = -7,
	
	UIFarmersMarketNativeItemTextView = -8,
	UIFarmersMarketNativeItemTextField = -9,
	UIFarmersMarketNativeItemSearchBar = -10,
	
	UIFarmersMarketNativeItemPicker = -11,
	UIFarmersMarketNativeItemDatePicker = -12,
	
	UIFarmersMarketNativeItemInfoLight = -13,
	UIFarmersMarketNativeItemInfoDark = -14,
	
	UIFarmersMarketNativeItemDisclosure = -15,
	
	UIFarmersMarketNativeItemContactAdd = -16
};
